...
const CTAButton = ({ size = '320x50' }) => {
  if (size === '300x250') {
    return (
      <div className="absolute bottom-0 left-0 right-0 h-12 flex items-center justify-center bg-white text-black border-t border-gray-200 gap-2">
        <img 
          src="https://www.appier.com/hubfs/Appier%20Website%20Images/Logos/appier-logo.svg" 
          alt="Appier" 
          className="h-4 w-auto"
        />
        <button className="bg-[#0074e9] hover:bg-[#0056b3] text-white text-xs px-3 py-1 rounded flex items-center gap-1">
          <span>Buy Me</span>
        </button>
      </div>
    );
